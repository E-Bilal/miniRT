...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/10/02 23:01:33 by bel-bouc          #+#    #+#             */
/*   Updated: 2024/11/25 16:50:23 by senayat          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../miniRT.h"

static void	inc_dimension(t_all_data *t)
{
	float	dimension;
...
static void	inc_fov(t_all_data *t)
{
	int	fov;
...
static void	inc_bright_ambient(t_all_data *t)
{
	float	bright_amb;

	bright_amb = t->menu.value_f;
	if (bright_amb + 0.1 <= 1.01)
		bright_amb += 0.1;
